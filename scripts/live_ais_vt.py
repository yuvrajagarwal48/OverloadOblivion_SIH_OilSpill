...
#     def filter_ais_data(self,data, lat_range, long_range):
#         filtered_ais_data = []
...
#             if lat_range[0] <= ais_data["LATITUDE"] <= lat_range[1] and long_range[0] <= ais_data["LONGITUDE"] <= long_range[1]:
#                 # Create a dictionary for the valid entry
#                 ais_dict = {
#                     "MMSI": ais_data["MMSI"],
#                     "TIMESTAMP": ais_data["TIMESTAMP"],
...
#                     "IMO": ais_data["IMO"],
#                     "NAME": ais_data["NAME"],
#                     "CALLSIGN": ais_data["CALLSIGN"],
#                     "TYPE": ais_data["TYPE"],
#                     "A": ais_data["A"],
#                     "B": ais_data["B"],
#                     "C": ais_data["C"],
#                     "D": ais_data["D"],
#                     "DRAUGHT": ais_data["DRAUGHT"],
#                     "DESTINATION": ais_data["DESTINATION"],
#                     "LOCODE": ais_data["LOCODE"],
#                     "ETA_AIS": ais_data["ETA_AIS"],
#                     "ETA": ais_data["ETA"],
#                     "SRC": ais_data["SRC"],
#                     "ZONE": ais_data["ZONE"],
#                     "ECA": ais_data["ECA"],
#                     "DISTANCE_REMAINING": ais_data["DISTANCE_REMAINING"],
#                     "ETA_PREDICTED": ais_data["ETA_PREDICTED"],
#                 }
